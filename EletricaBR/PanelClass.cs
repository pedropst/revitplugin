...
namespace TCC
{
    public class PanelClass
    {
        ...
        {
            if ((panel.Category.Name == "Electrical Equipment" || panel.Category.Name == "Equipamento elétrico") && panel.get_Parameter(BuiltInParameter.RBS_ELEC_PANEL_NAME) != null)
            {
                this.id = panel.Id;
                ...
                while (seti.MoveNext())
                {
                    ...
                    circuits.Add(wire);
                    circuitsNotOrdered.Add(wire.StartSlot.ToString());
                }
            ...
            {
                TaskDialog.Show("ERRO", "ELEMENTO SELECIONADO NÃO É VÁLIDO COMO QUADRO");
            }
        }
